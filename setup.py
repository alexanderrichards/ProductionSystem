...
#                      'mysql-python',
    ...
    extras_require={
        ...
        'dev': ['Sphinx',
                ...
                'pytest-pylint',
                'pytest-cov',
                'pep257;python_version<"3"',
                'pep8;python_version<"3"',
                'pytest-pep8;python_version<"3"',
                'pytest-pep257;python_version<"3"',
                'pycodestyle;python_version>"3"',
                'pydocstyle;python_version>"3"',
                'pytest-pycodestyle;python_version>"3"',
                'pytest-pydocstyle;python_version>"3"'],
    },
