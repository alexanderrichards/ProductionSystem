...
class TestTemporaryFileManagerContext(TestCase):
    ...
    def test__init__(self):
        """
        Verify context initialization behavior.
    ...
    def test_new_file(self):
        """
        Verify temporary file creation behavior.
    ...
    def test_new_dir(self):
        """
        Verify temporary directory creation behavior.
